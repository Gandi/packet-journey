...
#define rdpdk_calloc(str, nb_item, item_len, align, socket) calloc((nb_item), (item_len))
...
#define rdpdk_calloc(str, nb_item, item_len, flag, socket) rte_calloc_socket(str, (nb_item), (item_len), flag, socket)
